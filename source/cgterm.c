...
/* AC  */
  "######## Bookmarks from telbbs.com ########",
  "bookmark = The Warp Zone, warpzone.thebbs.org",
  "#bookmark = Temporal Vortex, bbs.petscii.com, 6400",
  "#bookmark = Antidote, antidote.hopto.org",
  "#bookmark = Castle Carbonek, 65.40.213.24",
  "#bookmark = The Dragon's Eye, dragonseye.dyndns.org, 6400",
  "#bookmark = Elm Street, elmstreet.dyndns.org",
  "#bookmark = The Forgotten Realms, forgottenrealmsbbs.org",
  "#bookmark = The Grave Yard, thegraveyard.dyndns.org",
  "#bookmark = Jamming Signal, bbs.jammingsignal.com",
  "#bookmark = The Lost Caverns, lostcavernsbbs.dyndns.org, 6001",
  "#bookmark = The Lost Caverns2, lostcavernsbbs.dyndns.org, 6002",
  "#bookmark = Mad World, madworld.bounceme.net",
  "#bookmark = Renaissance City, renaissancecitybbs.dyndns.tv",
/* ac */
  NULL
};
...
/* AC */
#ifdef __amigaos__
  const char *version = "\0$VER: CGTerm 1.7B2 (28.05.2005) Port by Alex Carmona";
#endif
/* ac */
...
/* AC */
#elif __amigaos__
  if (cfg_readconfig("PROGDIR:data/cgterm.cfg") < 0) {
    return(1);
  }
  if (cfg_read == 0) {
    cfg_writeconfig(default_cgterm_cfg, "PROGDIR:data/cgterm.cfg");
    if (cfg_readconfig("PROGDIR:data/cgterm.cfg") < 0) {
      return(1);
    }
  }
